...
const Receipt = () => {
  const openPDFInNewTab = () => {
    const element = document.getElementById("receipt-content"); // Get the element to convert to PDF

    // Set the width for the PDF (e.g., 210mm for A4 width)
    const pdfWidth = 76; // in mm
    ...
    const opt = {
      ...
      jsPDF: {
        ...
        // Set the width (and height if needed) for the PDF
        format: [pdfWidth, 800], // A4 size: 210mm width, 297mm height
      },
    };

    // Use html2pdf to generate PDF and get data URL
    html2pdf()
      .from(element)
      .set(opt)
      ...
      <div style={{ display: "nones" }}>
        <div id="receipt-content" className="receipt-content">
          ...
          <div className="table">
            ...
            <div className="row ">
              <p className="td td-1 pair-col-bold reward-row">
                Reward Amount/ :
              </p>
          ...
          <div className="receipt-info">
            <p>
              RIGHT TO REFUND:-You the customer can cancel your transaction for
              full refund within 30 minutes after you place your transaction
              unless the fund picked up or deposited. If your order was placed
              more than 30 minutes prior to your requesting a refund, you are
              entitled to a refund of all money received for transmittal within
              ten (10) days of receipt of a written request for refund unless
              any of the following occurs :(a)The money have been transmitted
              and delivered to the recipient prior to receipt of the written
              request for a refund;(b) Instruction have been given committing an
              equivalent amount of money the person designated by the customer
              prior to receipt of a written request for a refund; (c)The company
              and/or its authorized delegate has reason to believe that a crime
              has occurred, is occurring or may potentially occur as a result of
              transmitting the money as requested by the customer or refunding
              the money as requested by the customer, or (d) The company is the
              otherwise barred by the law from making a refund. TRANSACTION TO
              ACCOUNTS:-Please make sure the account number, Bank details, and
              mobile number are correct before sending. Otherwise, Money will be
              sent to the wrong account and the company is not responsible. The
              company makes money from currency exchange, when you choosing a
              money transmitter carefully compare both transfer fee and exchange
              rates. The transfer may take three to five days.
              <span className="receip-info-capital">
                CONSUMER FRAUD ALERT:-NEVER SEND MONEY TO SOMEONE YOU DON`T
                REALLY KNOW.
              </span>
            </p>
